...
if(isset($_POST['form4'])) {
    ...
    $success_message = 'Les informations du paramètres du formulaire de contact ont été mises à jour avec succès.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Les paramètres de la section activées / Désactivées ont été mise à jour avec succès .';
}
...
/*if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'L URL de l appel à l action Lire la suite ne peut pas être vide<br>';
    }
...
if(isset($_POST['form6_4'])) {
    ...
    if(empty($_POST['featured_product_title'])) {
        $valid = 0;
        $error_message .= 'Le titre du produit spécial ne peut pas être vide<br>';
    }

    if(empty($_POST['featured_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Le sous-titre du produit spéciale ne peut pas être vide<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données des produits spéciaux ont été mises à jour avec succès.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'Le titre du nouveau produit ne peut pas être vide<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Le sous-titre de nouveau produit ne peut pas être vide <br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données des nouveaux produits ont été mises à jour avec succès.';
...
if(isset($_POST['form6_6'])) {
    ...
    if(empty($_POST['popular_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Le sous-titre de produit populaire ne peut pas être vide <br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données des produits populaires ont été mises à jour avec succès .';
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'Les informations de newsletter ont été mis à jour avec succès.';
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Le script Entête et corps est mis à jour avec succès.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_4" data-toggle="tab">Paramètres de message</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Produits</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Paramètres d'accueil</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Paramètres des bannières</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Paramètres de paiement</a></li>
                        <li><a href="#tab_10" data-toggle="tab">Scripts de l'entête & corps</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1">Mettre à Jour Logo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Mettre à Jour Favicon</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="newsletter_on_off" class="form-control" style="width:auto;">
                                                <option value="1" <?php if($newsletter_on_off == 1) {echo 'selected';} ?>>activé</option>
                                                <option value="0" <?php if($newsletter_on_off == 0) {echo 'selected';} ?>>désactivé</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Email de contact </label>
                                        <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (combien de produits spéciale?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_featured_product_home" value="<?php echo $total_featured_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (combien de nouveaux produits?)<span>*</span></label>
                                        <div class="col-sm-2">
                        ...
                        <div class="tab-pane" id="tab_6">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section de service </label>
                                        <div class="col-sm-4">
                                            <select name="home_service_on_off" class="form-control" style="width:auto;">
                                            	...
                                            	<option value="0" <?php if($home_service_on_off == 0) {echo 'selected';} ?>>Désactivé</option>
                                            </select>
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="home_welcome_on_off" class="form-control" style="width:auto;">
                                            	...
                                            	<option value="0" <?php if($home_welcome_on_off == 0) {echo 'selected';} ?>>Désactivé</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des produits Spéciaux</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des Nouveaux  produits  </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des produit Populaire </label>
                                        <div class="col-sm-4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Mots clés </label>
                                        <div class="col-sm-8">
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Section des produits spéciaux</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre du produit spéciaux <span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="featured_product_title" value="<?php echo $featured_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre du produit spéciaux <span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <h3>Section des Nouveaux  produits</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre du Nouveaux produits<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre de Nouveaux produits <span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <h3>Section produit Populaire </h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre du produits Populaires <span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="popular_product_title" value="<?php echo $popular_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre du produits Populaires<span>*</span></label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de page de mot de passe oublié existant </h4>
                                        <p>
                        ...
                        <div class="tab-pane" id="tab_9">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">PayPal - E-mail professionnel  </label>
                                            <div class="col-sm-5">
                        ...
                        <div class="tab-pane" id="tab_10">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Code avant l'étiquette &lt;/entête&gt; </label>
                                            <div class="col-sm-8">
                                                <textarea name="before_head" class="form-control" cols="30" rows="10"><?php echo $before_head; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Code après l'étiquette &lt;corps&gt; </label>
                                            <div class="col-sm-8">
                                                <textarea name="after_body" class="form-control" cols="30" rows="10"><?php echo $after_body; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Code avant l'étiquette &lt;/corps&gt; </label>
                                            <div class="col-sm-8">
