...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez  sélectionner une super catégorie<br>";
    }

    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "vous devez séléctionnner une catégorie<br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez séléctionner une sous-catégorie<br>";
    }
...
// session_start();
    	...
    	$success_message = 'Le produit est ajouté avec succés.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Prix ancien<br><span style="font-size:10px;font-weight:normal;">(en DH)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Prix actuel<span>*</span><br><span style="font-size:10px;font-weight:normal;">(en DH)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Sélectionnez la couleur</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Photo spéciale<span>*</span></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
			                    <input type="button" id="btnAddNew" value="Ajouter un article" style="margin-top: 5px;margin-bottom:10px;border:0;color: #fff;font-size: 14px;border-radius:3px;" class="btn btn-warning btn-xs">
			                </div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">La Description</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Speciale</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Est Speciale?</label>
							<div class="col-sm-8">
