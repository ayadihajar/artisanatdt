...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez sélectionner une sous-catégorie <br>";
    }
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ancien Prix<br><span style="font-size:10px;font-weight:normal;">(en DH)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Photo Spéciale Existante</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Changer la Photo Spéciale </label>
							<div class="col-sm-4" style="padding-top:4px;">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Est Spéciale?</label>
							<div class="col-sm-8">
