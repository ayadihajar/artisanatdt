...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les frais de livraison ont été ajoutés avec succès.';
    }
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: Si un pays n'existe pas dans la liste ci-dessus, les frais de livraison "Reste du Monde" suivants seront appliqués.</h4>
