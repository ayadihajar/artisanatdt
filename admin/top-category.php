    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Attention! Tous les produits, catégories et Sous catégories sous cette Super catégorie seront supprimés de tous les tableaux tels que le tableau des commandes, le tableau des paiements, le tableau des tailles, le tableau des couleurs, etc.</p>
            </div>
