	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top">
				...
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Panneau Admin</span>
    		...
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'settings.php') ) {echo 'active';} ?>">
			          <a href="settings.php">
			            <i class="fa fa-hand-o-right"></i> <span>Paramètres de site</span>
			          </a>
			        </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="order.php">
                            <i class="fa fa-hand-o-right"></i> <span>Gestion des commandes</span>
                        </a>
                    </li>
					...
					<li class="treeview <?php if( ($cur_page == 'producer.php') || ($cur_page == 'producer-add.php') ) {echo 'active';} ?>">
			          <a href="producer.php">
			            <i class="fa fa-hand-o-right"></i> <span>Producteur</span>
			          </a>
			        </li>
					...
					<li class="treeview <?php if( ($cur_page == 'customer-message.php') ) {echo 'active';} ?>">
                       <a href="customer-message.php">
                          <i class="fa fa-hand-o-right"></i> <span>Voir les Messages</span>
                        </a>
                    </li>
					<li class="treeview <?php if( ($cur_page == 'language.php') ) {echo 'active';} ?>">
                       <a href="language.php">
                          <i class="fa fa-hand-o-right"></i> <span>Langage de site</span>
                        </a>
                    </li>
