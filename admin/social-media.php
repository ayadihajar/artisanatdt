...
if(isset($_POST['form1'])) {
	...
	$success_message = 'Les URL des réseaux sociaux ont été mises à jour avec succès .';
		...
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">						
						<p style="padding-bottom: 20px;">Si vous ne souhaitez pas afficher de réseau social dans votre page d'accueil, laissez simplement le champ de saisie vide.</p>
