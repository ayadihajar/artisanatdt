...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <h3 style="font-size:20px;font-weight:500;">Base</h3>
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chercher un produit <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[2]" value="<?php echo $lang_ids[2]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chercher <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Série <span>*</span></label>
                    <div class="col-sm-6">
		...
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Se déconnecter <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Inscription réussi <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mettre à jour panier <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Caisse <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Statut de paiement <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[30]" value="<?php echo $lang_ids[30]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mode de paiement <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Sélectionnez un mode <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Envoyer à ces détails <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Incluez correctement l'id de transaction et d'autres informations <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">				
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Produits en relation <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[155]" value="<?php echo $lang_ids[155]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Voir tous les produits en relation ci-dessous <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Partagez ce produit <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Donnez un avis <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Poster le commentaire<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[67]" value="<?php echo $lang_ids[67]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Vous avez déjà donné un avis! <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[68]" value="<?php echo $lang_ids[68]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">L'avis est envoyée avec succès! <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[163]" value="<?php echo $lang_ids[163]; ?>">
                    </div>
                </div>	
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Vous devez être connecté pour donner un avis<span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Commenter <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;">Facturation et Livraison</h3>
        <div class="box box-info">
            <div class="box-body">
            	<div class="form-group">
            	...
            	<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Continuer le shopping <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mettre à jour les informations de facturation et de livraison <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;">S'abonner</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Retaper le nouveau mot de passe <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Nom de la compagnie <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Province <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Articles spéciaux <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Information de Contact <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[114]" value="<?php echo $lang_ids[114]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Forme de contact <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
            	<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Félicitations! Le paiement est réussi. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[121]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[121]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Les informations de facturation et de livraison ont été mises à jour avec succès. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Les informations de profil ont été mises à jour avec succès. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">L'email et / ou le mot de passe ne peuvent pas être vides. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[132]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[132]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">L'adresse email ne correspond pas. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[133]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[133]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">L'adresse email doit être valide. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[134]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[134]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">L'adresse email existe déjà. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[147]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[147]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Votre adresse email ne se trouve pas dans notre système. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Votre e-mail a été vérifié avec succès. Vous pouvez maintenant vous connecter à notre site Web. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Veuillez saisir de nouveaux mots de passe et retaper. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">DEMANDE DE RÉINITIALISATION DE MOT DE PASSE - VOTRE SITE.COM <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Un lien de confirmation est envoyé à votre adresse e-mail. Vous y obtiendrez les informations de réinitialisation du mot de passe. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Pardon! Votre compte est inactif. Veuillez contacter l'administrateur. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[148]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[148]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Confirmation par email d'inscription pour VOTRE SITE WEB. <span>*</span></label>
                    <div class="col-sm-6">
