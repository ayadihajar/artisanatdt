...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Nom de la supere catégorie existe déjà<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La supere catégorie a été mise à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier la Super catégorie</h1>
	</div>
