...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Votre e-mail a été vérifié avec succès. Vous pouvez maintenant vous connecter à notre site Web.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Cliquez ici pour connecter</a></p>';     
    }
}
?>
