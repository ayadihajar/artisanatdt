...
<head>
	...
	if($cur_page == 'customer-billing-shipping-update.php') {
		?>
		<title>Mettre à jour les informations de facturation et de livraison - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
...
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<a href="producteur/login.php"><i class="fa fa-sign-in"></i>Espace producteur</a>
			</div>-->
			<div class="col-md-6 right">
				<ul>
					
					<?php
					echo "<li><a href=\"producteur/login.php\"><i class=\"fa fa-sign-in\"></i>Espace producteur</a></li>";
