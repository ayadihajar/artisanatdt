		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        Vous devez remplir toutes les informations de facturation et de livraison à partir de votre tableau de bord afin de passer la commande. Veuillez remplir les informations en accédant à <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">ce lien</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
